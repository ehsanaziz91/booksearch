...
<head>
<title><?php echo($pageTitle); ?> : Technical University of Malaysia Malacca Libraries</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link rel="alternate" type="application/rss+xml" href="http://feeds.feedburner.com/msulibrarySpotlightTools"/>
...
<div class="container">
    ...
    $key = isset($_GET['key']) ? $_GET['key'] : 'AIzaSyAJQY0SRpFwL4rItRrAtYlJV3CaLDqJoCs';
    ...
    <form id="searchForm" name="searchForm" action="<?php echo basename(__FILE__); ?>" method="get">
        <fieldset id="searchBox">
            <label>Find:</label>
            <input class="text" id="q" name="q" type="text" placeholder="keyword or id" onfocus="this.value=''; this.onfocus=null;" />
            ...
            <input class="submit" id="submit" name="submit" type="submit" value="Search Books"  />
        </fieldset>
    </form>
